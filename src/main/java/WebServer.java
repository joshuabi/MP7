        ...
        try {
            ...
            switch (transformation) {
                ...
                case "mystery1":
                    ...
                    transformedPixels = Transform.mystery1(pixels);

                    break;

                case "mystery2":

                    transformedPixels = Transform.mystery2(pixels);

                    break;

                case "mystery3":

                    transformedPixels = Transform.mystery3(pixels);

                    break;

                case "mystery4":

                    transformedPixels = Transform.mystery4(pixels);

                    break;

                case "mystery5":

                    transformedPixels = Transform.mystery5(pixels);

                    break;

                case "mystery6":

                    transformedPixels = Transform.mystery6(pixels);

                    break;

                case "mystery7":

                    transformedPixels = Transform.mystery7(pixels);

                    break;

                case "mystery8":

                    transformedPixels = Transform.mystery8(pixels);
